...
@section('content')
    <div class="mb-8 border-b border-[#E5E3DB] pb-5">
        ...
        <p class="mt-1 text-sm text-slate-500">Memperbarui kelas atas nama <span class="font-medium text-[#16213A]">XII AKL 1</span>.</p>
    </div>
        ...
        <div>
            ...
            <select id="major_id" name="major_id"
                ...
                @foreach ($majors as $major)
                    <option value="{{ $major['id'] }}" @selected($major['code'] == 'AKL')>{{ $major['code'] }}</option>
                @endforeach
            </select>
        </div>
